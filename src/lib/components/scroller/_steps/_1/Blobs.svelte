...
<div class="inner-container" in:fade|global={{ duration: 400, delay: 500 }}>
	<svg bind:this={svgContainer} width="100%" height={height} transition:fade|global={{ duration: 400 }}>
		<path bind:this={democratLine} fill={getCSSVar('--color-theme-dem-blue')} opacity="0.75" />
		<path bind:this={republicanLine} fill={getCSSVar('--color-theme-gop-red')} opacity="0.75" />
	</svg>
</div>
